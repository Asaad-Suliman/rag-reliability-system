...
| **Adjacent passage** | Not reproduced here (third-party text). `u05`'s `near_miss_to` span: canonical offsets [224441, 224704) of `doc_01M0D39WZDYY7STA3PHWT5R4C7`, page 199, inside chunk `chk_01M0D4BMH0YEVX15HMY5B5SMP0` [224405, 225692). |
